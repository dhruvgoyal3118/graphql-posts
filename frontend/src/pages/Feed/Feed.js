...
class Feed extends Component {
  ...
  finishEditHandler = postData => {
    ...
    fetch('http://localhost:8080/post-image',{
      ...
      if(this.state.editPost)
      {
        graphqlQuery={
          query: `
          mutation updatethePost($postId:ID!,$title:String!, $content:String!, $imageUrl:String!){
      ...
      .then(resData => {
        ...
        this.setState(prevState => {
          ...
          let updatedTotalPosts = prevState.totaPosts;
  ...
  deletePostHandler = postId => {
    ...
    let graphqlQuery = {
      query:`
      mutation deletethePost($postId:ID!){
